...
ClapTrap::ClapTrap(void): name("Default"), hit_points(HIT_POINTS), energy_points(ENERGY_POINTS), attack_damage(ATTACK_DAMAGE)
{
    std::cout << "ClapTrap default constructor called" << std::endl;
}

ClapTrap::ClapTrap(const std::string name): name(name), hit_points(HIT_POINTS), energy_points(ENERGY_POINTS), attack_damage(ATTACK_DAMAGE)
{
